...
public class TestSpecialMultiFieldSyncService(DbTestContext context, IFileMakerApiClient fmClient, InMemoryFmMultiFieldMapper multiFieldMapper)
    : FmSyncService<FmSpecialSourceTestClass, FmTargetTestClass, FmSpecialSourceTestClassSync>
{
    ...
    public override async Task<bool> UpdateEntity(int fileMakerRecordId, CancellationToken token)
    {
        try
        {
            ...
            var fmEntity = await fmClient.GetByFileMakerIdAsync<FmSpecialSourceTestClass>(fileMakerRecordId,
            ...
            await multiFieldMapper.Map(fmEntity, dbEntity.FmTargetTestClassMultifields);
    ...
    protected override async Task<int> DeleteEntities(ICollection<int> toDeleteIds, CancellationToken token)
    {
        ...
        try
        {
            ...
            {
                int i = 0;
                foreach (var entity in context.FmTargetTestClasses
