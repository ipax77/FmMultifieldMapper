...
internal class InMemoryFmMultiFieldMapper(DbTestContext context) : FmMultiFieldMap
{
...
internal class CacheFmMultiFieldMapper(DbTestContext context) : FmMultiFieldMap
{
    private bool isInit;
